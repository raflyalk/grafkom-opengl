...
def drawSmoke():
    ...
    while loop < MAX_SMOKE_PARTICLES:
        if (smoke_par[loop].alive == True):
            ...
            glVertex3f(x-0.025, y-0.025, z)
            glVertex3f(x, y-0.025, z)

            glVertex3f(x, y, z-0.025)
            glVertex3f(x-0.025, y, z-0.025)
            glVertex3f(x-0.025, y-0.025, z-0.025)
            glVertex3f(x, y-0.025, z-0.025)
